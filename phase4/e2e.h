 ...
 * Handles in-memory AEAD (AES-256-GCM), Base64 encoding/decoding,
 * and DH-based peer session key exchange.
 */
...
// Manages thread-safe E2E sessions and keys for all peers
class E2EManager {
public:
